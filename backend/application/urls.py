...
urlpatterns = [
    ...
    path("government-officer-get-income-certificates/",views.get_income_certificates,name="government-officer-get-income-certificates"),
    path("government-officer-get-non-creamy-layer-certificates/",views.get_non_creamy_layer_certificates,name="government-officer-get-non-creamy-layer-certificates"),
    path("government-officer-get-users/",views.get_users,name="government-officer-get-users"),
