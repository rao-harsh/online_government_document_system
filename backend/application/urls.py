...
urlpatterns = [
    ...
    # path("income-certificate-form/",views.income_certificate_form,views="income-certificate-form"),
    path("non-creamy-layer-form/",views.non_creamy_layer_form,name="non-creamy-layer-form"),
